...
# Based on Photoshop script by Yan Senez
# Version 1.0
...
def add_image_names_to_board(img, drawable, text_font, text_size, text_color, text_offset):
    ...
    - drawable: Le calque actif
    - text_font: Police de caracteres a utiliser
    - text_size: Taille du texte en pixels
    - text_color: Couleur du texte (objet gimpcolor.RGB ou tuple)
    - text_offset: Distance entre le bas de la cellule et le texte en pixels
    """
    global log_file_path
    ...
    try:
        ...
        for i, layer_info in enumerate(content_layers):
            ...
            text_layer = pdb.gimp_text_fontname(
                ...
                0,  # border
                True,  # antialias
                text_size,  # Taille specifiee par l'utilisateur
                PIXELS,
                text_font  # Police specifiee par l'utilisateur
            )
...
register(
    ...
    "Yan Senez",
    "2025",
    "<Image>/File/Open Board/Add Image Names...",
    "RGB*, GRAY*",
    [
        # ┌─────────────────────────────────────────────────────────────┐
        # │  ✏️  TEXT SETTINGS                                          │
